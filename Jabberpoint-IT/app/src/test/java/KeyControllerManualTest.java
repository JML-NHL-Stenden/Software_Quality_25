...
public class KeyControllerManualTest
{
    ...
    public void testNextSlideKey()
    {
        ...
        KeyEvent keyEvent = new KeyEvent(new Component()
        {
        }, KeyEvent.KEY_PRESSED, System.currentTimeMillis(), 0, KeyEvent.VK_PAGE_DOWN, ' ');
    ...
    public void testPrevSlideKey()
    {
        ...
        KeyEvent keyEvent = new KeyEvent(new Component()
        {
        }, KeyEvent.KEY_PRESSED, System.currentTimeMillis(), 0, KeyEvent.VK_PAGE_UP, ' ');
        keyController.keyPressed(keyEvent);
